...
1.2. .\my_env\Scripts\activate
1.3. pip install Django
2. django-admin startproject my_project
3.1. python manage.py startapp my_app
3.2. include my_app//urls.py to the ROOT urls.py
4.1. python manage.py migrate
4.2. python manage.py sqlmigrate my_app 0001
5.           ...  ... makemigrations my_app
=======================================================
